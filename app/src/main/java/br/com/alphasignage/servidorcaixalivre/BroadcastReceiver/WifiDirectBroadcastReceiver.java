package br.com.alphasignage.servidorcaixalivre.BroadcastReceiver;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        /*get the list*/
            ...
            if (State == WifiP2pManager.WIFI_P2P_DISCOVERY_STARTED) {
                //Toast.makeText(mActivity, "Pesquisa iniciada", Toast.LENGTH_SHORT).show();
            }else if (State == WifiP2pManager.WIFI_P2P_DISCOVERY_STOPPED) {
                //Toast.makeText(mActivity, "Pesquisa finalizada", Toast.LENGTH_SHORT).show();
            }
        }
